...
EXPECTED = {
    ...
    "ortho-mixed-g15": ["ABC", "DEF", "GHITUV", "JK", "LM", "NOP", "QRS"],
...
def main() -> None:
    ...
    for group in groups:
        ...
        assert group["optionShuffleVersion"] == (2 if group["id"] == "ortho-mixed-g15" else 1)
    ...
    print({"groups": 16, "stems": 52, "options": 110, "ranking": 1, "shuffled": 16, "status": "ok"})
