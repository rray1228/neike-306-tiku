...
EXPECTED = {
    ...
    "ortho-mixed-g04": ["ABC"],
    "ortho-mixed-g05": ["ABC", "DEFG", "H"],
    "ortho-mixed-g06": ["ABC", "DEFG", "HI"],
    ...
    "ortho-mixed-g15": ["A", "B", "C", "D", "E", "F", "G"],
    "ortho-mixed-g16": ["A", "B", "C", "D", "E", "F", "G"],
    "ortho-mixed-g17": ["A", "B", "C", "D", "E"],
    "ortho-mixed-g18": ["ABC"],
...
def main() -> None:
    ...
    assert sum(len(group["stems"]) for group in groups) == 65
    assert sum(len(group["options"]) for group in groups) == 110
    ...
    print({"groups": 19, "stems": 65, "options": 110, "ranking": 1, "shuffled": 19, "status": "ok"})
