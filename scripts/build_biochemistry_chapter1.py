...
def main():
    ...
    energy = "红细胞代谢与高能化合物"
    groups = [
        group(1, "糖酵解关键酶", carbohydrate, ["ATP、丙氨酸", "AMP、ADP", "G→G-6-P", "ATP、柠檬酸", "PEP→丙酮酸、ATP", "G-6-P、长链脂酰 CoA", "F-6-P→F-1,6-DP", "果糖-1,6-二磷酸", "葡萄糖", "果糖-2,6-二磷酸（最强激活剂）"], [("丙酮酸激酶催化：", "E"), ("丙酮酸激酶激活剂：", "H"), ("丙酮酸激酶抑制剂：", "A"), ("己糖激酶催化：", "C"), ("己糖激酶激活剂：", "I"), ("己糖激酶抑制剂：", "F"), ("磷酸果糖激酶-1催化：", "G"), ("磷酸果糖激酶-1激活剂：", "BJ"), ("磷酸果糖激酶-1抑制剂：", "D")], 1, 4),
        group(2, "关键酶与非关键酶", carbohydrate, ["己糖激酶", "磷酸果糖激酶-1", "丙酮酸激酶", "丙酮酸脱氢酶复合体", "柠檬酸合酶", "异柠檬酸脱氢酶", "α-酮戊二酸脱氢酶复合体", "3-磷酸甘油醛脱氢酶", "磷酸甘油酸激酶", "乳酸脱氢酶 LDH", "琥珀酰 CoA 合成酶", "琥珀酸脱氢酶"], [("关键酶", "ABCDEFG"), ("非关键酶", "HIJKL")], 1, 5),
        group(3, "糖有氧氧化的关键酶", carbohydrate, ["己糖激酶", "磷酸果糖激酶-1", "丙酮酸激酶", "丙酮酸脱氢酶复合体", "柠檬酸合酶", "异柠檬酸脱氢酶", "α-酮戊二酸脱氢酶复合体"], [("糖酵解的关键酶", "ABC"), ("丙酮酸脱羧的关键酶", "D"), ("三羧酸循环的关键酶", "EFG")], 1, 4),
        group(4, "糖代谢途径的意义", carbohydrate, ["缺氧供能", "向肌肉迅速供能", "成熟红细胞获得能量的唯一途径", "瓦伯格效应：恶性肿瘤即使氧供正常也主要进行无氧氧化", "三大营养物质最终代谢去路、联系枢纽", "为氧化磷酸化提供还原当量"], [("无氧氧化的意义", "ABCD"), ("三羧酸循环的意义", "EF")], 1, 6),
        group(11, "糖代谢途径定义", carbohydrate, ["葡萄糖转化为 5-磷酸核糖", "葡萄糖转化为丙酮酸", "葡萄糖转化为二氧化碳", "葡萄糖转化为乳酸"], [("糖酵解途径是指", "B"), ("葡萄糖无氧氧化指", "D"), ("葡萄糖有氧氧化指", "C"), ("葡萄糖磷酸戊糖途径指", "A")], 1, 3),
        group(5, "高能化合物", energy, ["乙酰 CoA", "脂酰 CoA", "丙二酰 CoA/丙二酸单酰 CoA", "HMG CoA", "NDP、NTP", "1,3-二磷酸甘油酸、PEP", "磷酸肌酸", "氨基甲酰磷酸", "焦磷酸（如 PRPP）", "葡萄糖-1-磷酸", "2,3-二磷酸甘油酸", "果糖-1,6-二磷酸", "三磷酸肌醇"], [("高能硫酯键", "ABCD"), ("高能磷酸键", "EFGHIJ")], 1, 7),
        group(12, "底物水平磷酸化", energy, ["己糖激酶", "磷酸甘油酸激酶", "丙酮酸脱氢酶", "丙酮酸激酶", "柠檬酸合酶", "琥珀酰 CoA 合成酶"], [("催化底物水平磷酸化的酶", "BDF")], 1, 5),
        group(13, "高能硫酯键的生理角色", energy, ["乙酰 CoA", "脂酰 CoA", "丙二酰 CoA/丙二酸单酰 CoA", "HMG CoA"], [("脂肪酸合成的重要物质", "C"), ("胆固醇、酮体合成的重要物质", "D"), ("三大营养物质最终代谢去路", "A"), ("脂肪酸的活化形式", "B")], 1, 7),
    ]
