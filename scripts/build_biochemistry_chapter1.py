...
def main():
    ...
    groups = [
        group(1, "糖酵解关键酶", glycolysis, ["PEP→丙酮酸、ATP", "G→G-6-P", "F-6-P→F-1,6-DP", "果糖-1,6-二磷酸", "葡萄糖", "AMP、ADP", "果糖-2,6-二磷酸（最强激活剂）", "ATP、丙氨酸", "G-6-P、长链脂酰 CoA", "ATP、柠檬酸"], [("丙酮酸激酶催化：", "A"), ("丙酮酸激酶激活剂：", "D"), ("丙酮酸激酶抑制剂：", "H"), ("己糖激酶催化：", "B"), ("己糖激酶激活剂：", "E"), ("己糖激酶抑制剂：", "I"), ("磷酸果糖激酶-1催化：", "C"), ("磷酸果糖激酶-1激活剂：", "FG"), ("磷酸果糖激酶-1抑制剂：", "J")], 1, 4),
