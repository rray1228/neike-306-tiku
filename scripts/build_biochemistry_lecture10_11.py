...
def main():
    ...
    bilirubin_groups = [
        ...
        bank(10, bilirubin_title, 4, "三种黄疸：按完整指标组合鉴别", [
            "肝细胞性黄疸", "梗阻性黄疸", "溶血性黄疸",
        ], [
            ("UCB 明显升高，CB/TB ＜0.2；尿胆原升高、尿胆红素阴性；尿深、粪便颜色也较深；ALT、AST、PT 多正常，ALP、GGT 多正常", ["溶血性黄疸"]),
            ("CB、UCB 均升高，CB/TB 0.2～0.5；尿胆原不定、尿胆红素＋；尿深、粪便正常或较浅；ALT、AST、PT 明显升高/异常，ALP、GGT 升高", ["肝细胞性黄疸"]),
            ("CB 明显升高，CB/TB ＞0.5；尿胆原降低、尿胆红素＋＋；尿深、粪便浅甚至白陶土样；ALT、AST、PT 可升高，ALP、GGT 明显升高", ["梗阻性黄疸"]),
        ], 2),
