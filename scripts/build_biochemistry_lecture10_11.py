...
def main():
    ...
    bilirubin_groups = [
        ...
        bank(10, bilirubin_title, 4, "三种黄疸鉴别", [
            "CB、UCB 均升高", "UCB 明显升高", "CB 明显升高", "胆红素均正常", "CB/TB ＞0.5", "CB/TB ＜0.2", "CB/TB 0.2～0.5", "CB/TB ＞0.8", "降低", "不定", "升高", "消失是所有病例的共同表现", "＋＋", "阴性", "＋", "三者均阴性", "尿深、粪便浅甚至白陶土样", "尿深、粪便正常或较浅", "尿深、粪便颜色也较深", "尿色浅、粪便深是共同表现", "ALT、AST、PT 多正常", "ALT、AST、PT 明显升高/异常", "ALT、AST、PT 可升高", "ALP、GGT 明显升高", "ALP、GGT 多正常", "ALP、GGT 升高",
        ], [
            ("溶血性黄疸的特点", ["UCB 明显升高", "CB/TB ＜0.2", "升高", "阴性", "尿深、粪便颜色也较深", "ALT、AST、PT 多正常", "ALP、GGT 多正常"]),
            ("肝细胞性黄疸的特点", ["CB、UCB 均升高", "CB/TB 0.2～0.5", "不定", "＋", "尿深、粪便正常或较浅", "ALT、AST、PT 明显升高/异常", "ALP、GGT 升高"]),
            ("梗阻性黄疸的特点", ["CB 明显升高", "CB/TB ＞0.5", "降低", "＋＋", "尿深、粪便浅甚至白陶土样", "ALT、AST、PT 可升高", "ALP、GGT 明显升高"]),
        ], 2),
