...
def evidence(page):
    return {
        ...
        "image": f"biochemistry/lecture-pages/lecture-04-page-{page:02d}.png",
...
def main():
    groups = [
        ...
        bank(5, "脂蛋白的作用与小肠脂质吸收", [
            "供能", "甘油一酯途径", "构成生物膜", "胆固醇", "二酰甘油", "外源性脂肪", "协助脂溶性维生素吸收", "维持体温", "参与细胞信号转导",
        ], [
            ("脂蛋白及脂类的生理作用", ["供能", "构成生物膜", "协助脂溶性维生素吸收", "维持体温", "参与细胞信号转导"]),
            ("可作为第二信使的脂质", ["二酰甘油"]), ("小肠吸收的外源性脂质原料", ["胆固醇", "外源性脂肪"]),
