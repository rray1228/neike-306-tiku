...
def main():
    groups = [
        ...
        bank(3, "甘油磷脂合成的活化中间物", ["CDP-乙醇胺", "磷脂酰丝氨酸", "脑磷脂", "二酰甘油", "磷脂酰肌醇", "CDP-胆碱", "脂酰 CoA", "肌醇", "CDP-二酰甘油", "卵磷脂", "心磷脂", "丝氨酸", "三酰甘油"], [("二酰甘油途径可合成", ["脑磷脂", "卵磷脂", "三酰甘油"]), ("CDP-二酰甘油途径可合成", ["磷脂酰丝氨酸", "磷脂酰肌醇", "心磷脂"]), ("脑磷脂活化的中间物", ["CDP-乙醇胺"]), ("卵磷脂活化的中间物", ["CDP-胆碱"]), ("三酰甘油合成的脂酰基供体", ["脂酰 CoA"]), ("合成磷脂酰肌醇还需要", ["肌醇"]), ("合成磷脂酰丝氨酸还需要", ["丝氨酸"]), ("磷脂酸合成的关键中间物", ["二酰甘油", "CDP-二酰甘油"])], 2),
        bank(4, "磷脂合成中的甲基化反应", ["脑磷脂", "磷脂酰丝氨酸", "卵磷脂", "鞘磷脂", "S-腺苷甲硫氨酸循环"], [("合成时与甲基化反应有关的磷脂", ["卵磷脂", "鞘磷脂"]), ("甲基供体相关循环", ["S-腺苷甲硫氨酸循环"])], 2),
        bank(5, "磷脂酶的水解产物", ["2-溶血磷脂", "1-溶血磷脂", "1,2-二酰甘油", "磷脂酸"], [("磷脂酶 A₁ 的水解产物", ["2-溶血磷脂"]), ("磷脂酶 A₂ 的水解产物", ["1-溶血磷脂"]), ("磷脂酶 C 的水解产物", ["1,2-二酰甘油"]), ("磷脂酶 D 的水解产物", ["磷脂酸"])], 2),
        ...
        bank(7, "胆固醇与胆汁酸合成的限速酶调节", ["生长激素", "胆汁酸", "胰高血糖素", "甲状腺激素", "胆固醇 7α-羟化酶是胆汁酸合成关键酶", "HMG-CoA 还原酶是胆固醇合成关键酶", "胆固醇", "糖皮质激素", "进食状态", "胰岛素使其去磷酸化", "午夜", "饥饿", "中午", "他汀类药物", "高糖", "高脂"], [("胆固醇合成的关键酶", ["HMG-CoA 还原酶是胆固醇合成关键酶"]), ("HMG-CoA 还原酶的激活因素", ["甲状腺激素", "胰岛素使其去磷酸化"]), ("HMG-CoA 还原酶的抑制因素", ["胆汁酸", "胰高血糖素", "胆固醇", "糖皮质激素", "他汀类药物"]), ("HMG-CoA 还原酶活性较高时", ["进食状态", "午夜", "高糖", "高脂"]), ("HMG-CoA 还原酶活性较低时", ["饥饿", "中午"]), ("胆汁酸合成的关键酶", ["胆固醇 7α-羟化酶是胆汁酸合成关键酶"]), ("胆固醇 7α-羟化酶的激活因素", ["生长激素", "甲状腺激素", "胆固醇", "糖皮质激素"]), ("胆固醇 7α-羟化酶的抑制因素", ["胆汁酸"])], 1),
